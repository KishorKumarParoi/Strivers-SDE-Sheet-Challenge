...
Node<int>* middleElement(Node<int>* head) {
    if (head == NULL || head->next == NULL)
        return head;
...
Node<int>* ms(Node<int>* head) {
    if (head == NULL || head->next == NULL)
        return head;

    Node<int>* mid = middleElement(head);
    Node<int>* leftHead = head;
    Node<int>* rightHead = mid->next;
    mid->next = NULL;
...
Node<int>* partitionLinkedList(Node<int>* head) {
    Node<int>* left = head;
    Node<int>* right = head;
...
// Partition function to divide around a pivot
Node<int>* partition(Node<int>* head, Node<int>* tail) {
    Node<int>* pivot = head;
...
void quickSort(Node<int>* head, Node<int>* tail) {
    // edge case
    if (head == NULL || tail == NULL || head == tail) {
        return;
    }

    Node<int>* pivot = partition(head, tail);

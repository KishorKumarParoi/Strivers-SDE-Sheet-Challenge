...
Date: 2024-06-22
Time: 16:35:34
Problem: Intersection Point of two linked list
Link:
*/
#include <bits/stdc++.h>
...
Node<int>* getIntersectionNode(Node<int>* headA, Node<int>* headB) {
    ...
    Node<int>* tempA = headA;
    Node<int>* tempB = headB;

    while (tempA != tempB) {
        // cout << tempA->data << " " << tempA->next << " ";
        // cout << tempB->data << " " << tempB->next << endl;
...
void solve() {
    ...
    Node<int>* headB = LinkedListTraversalFromArray(brr, m);
